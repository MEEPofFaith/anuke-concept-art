const shipTrail = newEffect(25, e => {
	const lightRegion = Core.atlas.find("kitty-concept-art-revenant-engine");
...
const ghots = extendContent(UnitType, "revenant", {});
ghots.create(prov(() => new JavaAdapter(HoverUnit, {
  update(){
    this.super$update();
